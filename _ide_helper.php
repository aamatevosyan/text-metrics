...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getDocumentProcessingRule($branchId, $courseWorkType, $mimeType)
        {
...
namespace  { 
            ...
            class DocumentProcessing extends \Domain\DocumentProcessing\Facades\DocumentProcessing {}
