            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :active="route().current('admin.dashboard')"
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                                ...
                                                <!-- Team Settings -->
                                                <jet-dropdown-link
                                                    :href="route('admin.teams.show', $page.props.user.current_team)">
                                                    Team Settings
                                                </jet-dropdown-link>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <jet-responsive-nav-link :active="route().current('admin.dashboard')"
                                                 :href="route('admin.dashboard')">
                            Dashboard
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <jet-responsive-nav-link :active="route().current('admin.profile.show')"
                                                     :href="route('admin.profile.show')">
                                Profile
                            </jet-responsive-nav-link>

                            <jet-responsive-nav-link v-if="$page.props.jetstream.hasApiFeatures"
                                                     :active="route().current('admin.api-tokens.index')"
                                                     :href="route('admin.api-tokens.index')">
                                API Tokens
                            </jet-responsive-nav-link>
...
import routes from "@admin/Misc/routes";
