...
<script>
    ...
    import JetActionMessage from '@front/Jetstream/ActionMessage.vue'
    import JetActionSection from '@front/Jetstream/ActionSection.vue'
    import JetButton from '@front/Jetstream/Button.vue'
    import JetConfirmationModal from '@front/Jetstream/ConfirmationModal.vue'
    import JetDangerButton from '@front/Jetstream/DangerButton.vue'
    import JetDialogModal from '@front/Jetstream/DialogModal.vue'
    import JetFormSection from '@front/Jetstream/FormSection.vue'
    import JetInput from '@front/Jetstream/Input.vue'
    import JetCheckbox from '@front/Jetstream/Checkbox.vue'
    import JetInputError from '@front/Jetstream/InputError.vue'
    import JetLabel from '@front/Jetstream/Label.vue'
    import JetSecondaryButton from '@front/Jetstream/SecondaryButton.vue'
    import JetSectionBorder from '@front/Jetstream/SectionBorder.vue'
