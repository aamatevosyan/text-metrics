...
<script>
    ...
    import JetActionMessage from '@supervisor/Jetstream/ActionMessage.vue'
    import JetActionSection from '@supervisor/Jetstream/ActionSection.vue'
    import JetButton from '@supervisor/Jetstream/Button.vue'
    import JetConfirmationModal from '@supervisor/Jetstream/ConfirmationModal.vue'
    import JetDangerButton from '@supervisor/Jetstream/DangerButton.vue'
    import JetDialogModal from '@supervisor/Jetstream/DialogModal.vue'
    import JetFormSection from '@supervisor/Jetstream/FormSection.vue'
    import JetInput from '@supervisor/Jetstream/Input.vue'
    import JetCheckbox from '@supervisor/Jetstream/Checkbox.vue'
    import JetInputError from '@supervisor/Jetstream/InputError.vue'
    import JetLabel from '@supervisor/Jetstream/Label.vue'
    import JetSecondaryButton from '@supervisor/Jetstream/SecondaryButton.vue'
    import JetSectionBorder from '@supervisor/Jetstream/SectionBorder.vue'
    ...
    export default defineComponent({
        ...
        methods: {
            createApiToken() {
                this.createApiTokenForm.post(route('supervisor.api-tokens.store'), {
                    preserveScroll: true,
                    onSuccess: () => {
            ...
            updateApiToken() {
                this.updateApiTokenForm.put(route('supervisor.api-tokens.update', this.managingPermissionsFor), {
                    preserveScroll: true,
                    preserveState: true,
            ...
            deleteApiToken() {
                this.deleteApiTokenForm.delete(route('supervisor.api-tokens.destroy', this.apiTokenBeingDeleted), {
                    preserveScroll: true,
                    preserveState: true,
