            ...
            <div v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature" class="mt-4">
                <jet-label for="terms">
                    <div class="flex items-center">
                        ...
                        <div class="ml-2">
                            I agree to the <a :href="route('admin.terms.show')" class="underline text-sm text-gray-600 hover:text-gray-900"
                                              target="_blank">Terms of
                            Service</a> and <a :href="route('admin.policy.show')" class="underline text-sm text-gray-600 hover:text-gray-900"
...
import JetAuthenticationCard from '@admin/Jetstream/AuthenticationCard.vue'
...
import JetValidationErrors from '@admin/Jetstream/ValidationErrors.vue'
